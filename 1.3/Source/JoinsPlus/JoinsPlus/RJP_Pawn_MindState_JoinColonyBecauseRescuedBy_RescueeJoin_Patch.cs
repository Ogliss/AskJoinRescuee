...
namespace RescueeJoinPlus
{
	...
	public static class RJP_Pawn_MindState_JoinColonyBecauseRescuedBy_RescueeJoin_Patch
	{
		public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
		{
			...
			MethodInfo tryRecruit = AccessTools.Method(typeof(InteractionWorker_RecruitAttempt), "DoRecruit", new Type[] { typeof(Pawn), typeof(Pawn), typeof(bool) });
		...
		public static void DoRescueDialog(Pawn by, Pawn pawn, bool useAudiovisualEffects = true)
		{
			ttexta = null;
			tlabela = null;
			...
			{
				InteractionWorker_RecruitAttempt.DoRecruit(by, pawn, useAudiovisualEffects);
			};
